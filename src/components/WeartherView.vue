<script setup>
    ...
    const items = ref([]);
    const url = ref(`https://api.openweathermap.org/data/2.5/forecast?lat=18.894734098621683&lon=99.01098071489052&appid=6fa40b3083d5909e56cfd230f54817a5`); 
...
<template>
  <HeadView/>
    <section class="vh-100" >
      <div><h1 style="text-align: center;" class="text_box"><strong>สภาพอากาศมหาวิทยาลัยแม่โจ้ </strong></h1></div>
